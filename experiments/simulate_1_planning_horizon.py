...
if __name__ == "__main__":
    ...
    confs += [
        NaiveConfiguration(baseconf, basedir, 3, flight_sequence_fpath3),
        MilpConfiguration(baseconf, basedir, 3, sigma=34, W=6, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=29, W=7, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=25, W=8, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=22, W=9, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=19, W=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=17, W=11, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=16, W=12, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=15, W=13, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=14, W=14, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=13, W=15, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=12, W=16, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=11, W=17, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=10, W=18, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=9, W=19, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
        MilpConfiguration(baseconf, basedir, 3, sigma=9, W=20, flight_sequence_fpath=flight_sequence_fpath3, time_limit=1800),
    ]
