...
if __name__ == "__main__":
    ...
    confs = [
        ...
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=5),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=10),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=15),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=20),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=25),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=30),
        MilpConfiguration(baseconf, basedir, 3, W=18, sigma=10, flight_sequence_fpath=flight_sequence_fpath3, time_limit=60),
    ]
