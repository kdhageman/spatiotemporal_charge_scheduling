...
#         simulator = MilpSimulator(MilpScheduler, params, sc, schedule_delta, W, plot_delta=plot_delta,
#                                   directory=directory)
...
#         os.makedirs(directory, exist_ok=True)
#         simulator = MilpSimulator(MilpScheduler, params, sc, schedule_delta, W, directory=directory, plot_delta=0.05)
...
#         params = Parameters(**p)
#
#         scheduler = MilpScheduler(params=params, scenario=sc, sigma=1)
...
#         sc = sf.next()
#
#         scheduler = MilpScheduler(params=params, scenario=sc_orig, sigma=2)
#         _, schedules = scheduler.schedule(sc)
#         self.assertTrue(len(schedules), 2)
#         self.assertEqual(schedules[0][0], (0, 2, 0))
#         self.assertEqual(schedules[1][0], (0, 0, 0))
...
#
#         # no need to charge
#         scheduler = MilpScheduler(params=params, scenario=sc)
#         _, schedules = scheduler.schedule(sc)
